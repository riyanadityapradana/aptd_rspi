...
(function () {
    ...
    function buildParams(includePaging) {
        ...
        params.set('tanggal_awal', el.start.value); params.set('tanggal_akhir', el.end.value); params.set('kd_poli', el.poli.value); params.set('kd_dokter', el.doctor.value); params.set('status_task99', el.status.value); params.set('search', state.search); params.set('sort', state.sort); params.set('direction', state.direction); params.set('per_page', state.per_page);
    ...
    el.reset.addEventListener('click',function(){el.start.value=defaults.start;el.end.value=defaults.end;el.poli.value='';rebuildDoctors();el.doctor.value='';el.status.value='semua';el.search.value='';state={page:1,per_page:20,sort:'tanggal',direction:'asc',search:''};el.perPage.value='20';syncSelect(el.poli);syncSelect(el.doctor);syncSelect(el.status);loadData();});
