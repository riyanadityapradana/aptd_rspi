...
$defaults = aptd_task4_default_filters();
$masterError = '';
...
try {
    ...
    error_log('Master Evaluasi Task ID 4: ' . $exception->getMessage());
...
<div class="task4-page">
    <section class="task4-panel">
        <div class="task4-title-row">
            <div>
                <h1 class="task4-title">INDIKATOR KESESUAIAN JADWAL DOKTER</h1>
                <p class="task4-subtitle">Evaluasi waktu Task ID 4 pasien BPJS dengan nomor registrasi paling awal per poli dan dokter.</p>
            </div>
        ...
        <form class="task4-filter" id="task4FilterForm" novalidate>
            ...
            <div>
                <label for="task4TanggalAkhir">Tanggal Akhir <span style="font-weight:400;color:#73869a;">(tidak termasuk)</span></label>
    ...
    <section class="task4-panel">
        <div class="task4-table-head">
            <div>
                <h2 class="task4-table-title">Detail Evaluasi Task ID 4</h2>
                <p class="task4-table-note" id="task4TableNote">Memuat data...</p>
            </div>
            <div class="task4-table-tools">
                <div class="task4-search">
                    <span class="glyphicon glyphicon-search"></span>
                    <input type="search" class="form-control" id="task4Search" placeholder="Cari poli, dokter, status..." aria-label="Cari data">
                </div>
            ...
            <table class="table table-bordered table-hover task4-table">
                <thead>
                    <tr>
                        ...
                        <th><button type="button" class="task4-sort" data-sort="no_registrasi_awal">No. Registrasi Awal <span class="task4-sort-icon"></span></button></th>
...
(function () {
    ...
    var apiUrl = 'page/t_kunjungan/rawat_inap/evaluasi_task4_bpjs_api.php';
    var exportUrl = 'page/t_kunjungan/rawat_inap/export_evaluasi_task4_bpjs.php';
        ...
        if (!rows.length) {
            ...
            elements.tableBody.innerHTML = rows.map(function (row, index) {
                ...
                return '<tr>'
                    ...
                    + '<td class="text-center">' + escapeHtml(row.no_registrasi_awal) + '</td>'
