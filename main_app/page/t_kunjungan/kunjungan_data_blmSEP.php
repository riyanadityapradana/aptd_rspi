...
$filter_stts = isset($_POST['stts']) ? trim($_POST['stts']) : 'Sudah';

// Build WHERE clause
$where_parts = [
    "pj.kd_pj = 'BPJ'",
    "rp.status_lanjut = 'Ralan'",
    "(bs.no_sep IS NULL OR bs.no_sep = '')",
...
<div class="row text-left">
    <div class="col">
        <h3 class="text-left" style="color: #666666; margin-bottom: 5px;">DATA PASIEN BPJS RAWAT JALAN YANG <span style="background-color: #fd0707;">BELUM</span> ADA SEP</h3>
    ...
    <div class="col-sm-12">
        <div class="dataTables_wrapper table-responsive-sm" style="padding-top: 0;">
            <div class="wrapper">
                ...
                <table class="table table-sm table-bordered table-hover" id="tableBlmSEP" style="width:100%; margin-top: 10px;">
                    ...
                    <tbody>
                        ...
                        if (count($data) > 0) {
                            ...
                            foreach ($data as $row) {
                                $row_num++;
                                $sep_status = (is_null($row['no_sep']) || $row['no_sep'] === '') ? '<span style="color: red; font-weight: bold;">BELUM</span>' : htmlspecialchars($row['no_sep']);
                                ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; background-color: #ffffe5;"><?php echo $sep_status; ?></td>
                                </tr>
                                <?php
                            }
                        } else {
                    ...
                    <tfoot>
                        <tr style="background-color: #f7be04; font-weight: bold;">
                            <td colspan="10" style="text-align: right; padding-right: 15px;">
...
$(document).ready(function(){
    ...
    $('#btnExport').on('click', function(){
        ...
        $.ajax({
            type: 'POST',
            url: 'main_app.php?page=export_blmSEP',
            data: formData,
            processData: false,
            contentType: false,
            xhrFields: {
            ...
            success: function(data, status, xhr){
                var filename = 'Pasien_BPJS_BlmSEP_' + new Date().toISOString().split('T')[0] + '.xlsx';
