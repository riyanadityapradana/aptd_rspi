...
$exportAction = 'page/t_klinis/t_kode_penyakit/rawat_inap/export_kode_penyakit_ab_ranap.php';
...
(function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        fetch('page/t_klinis/t_kode_penyakit/rawat_inap/kode_penyakit_ab_ranap_details.php?' + params.toString(), {
            method: 'GET',
