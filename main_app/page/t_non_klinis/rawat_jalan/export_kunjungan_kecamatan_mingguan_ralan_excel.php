...
$sheet->setCellValue('A2', 'DATA KUNJUNGAN PASIEN RAWAT JALAN PER KECAMATAN PER MINGGU');
...
$filename = 'kunjungan_kecamatan_mingguan_ralan_' . $selectedMonth . '_' . date('Ymd_His') . '.xlsx';
