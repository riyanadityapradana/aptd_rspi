...
if (!isset($_SESSION['login_aptd_rspi']) || $_SESSION['login_aptd_rspi'] !== true || !aptd_can_access($levelLogin, 'kunjungan_kecamatan_mingguan_ralan')) {
...
$title = 'Data Kunjungan Pasien Rawat Jalan per Kecamatan per Minggu';
...
$filename = 'kunjungan_kecamatan_mingguan_ralan_' . $selectedMonth . '_' . date('Ymd_His') . '.pdf';
