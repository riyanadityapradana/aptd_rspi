    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <div class="form-inline my-2 my-lg-0">
                    <span class="nav-user-badge">
                        ...
                        &nbsp;&nbsp;<?php echo htmlspecialchars($namaLogin, ENT_QUOTES, 'UTF-8'); ?> (<?php echo htmlspecialchars($levelLogin, ENT_QUOTES, 'UTF-8'); ?>)
                    </span>
                    <a class="nav-link nav-logout-link" href="../login/logout.php">
                        <span class="glyphicon glyphicon-log-out" style="color:#ffffff"></span>&nbsp;&nbsp;Logout
                    </a>
                </div>
            </div>
        </nav>
                ...
                <footer class="main-footer" style="position:fixed;bottom:0;left:0;right:0;width:100vw;background:#d9dde0;color:#00070c;z-index:9999;padding:0; height:40px; display:flex; align-items:center;">
                    <div style="overflow:hidden;white-space:nowrap;width:100vw;">
                        <marquee behavior="scroll" direction="left" scrollamount="6" style="font-size:17px;padding:8px 0;min-width:100vw;">
                            &copy; <?= date('Y') ?> IT-RSPI | Aplikasi Tarikan Data RSPI. Dikembangkan oleh Tim IT-RSPI. Seluruh hak cipta dilindungi undang-undang.
                        </marquee>
                    </div>
                </footer>
            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                ['#table2', '#table22', '#table4'].forEach(function(selector) {
